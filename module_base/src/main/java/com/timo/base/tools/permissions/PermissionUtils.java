...
public class PermissionUtils {
     ...
     */
    public static void onRequestPermissionsResult(int requestCode, PermissionGrantedListener listener,
    ...
    private static void notifyAlreadyHasPermissions(@NonNull Object object,
        ...
        onRequestPermissionsResult(requestCode, null, perms, grantResults, object);
    }

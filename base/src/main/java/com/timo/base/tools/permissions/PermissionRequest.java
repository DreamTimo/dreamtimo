...
import com.timo.base.tools.permissions.helper.PermissionHelper;
 ...
 *
 * @see PermissionUtils#requestPermissions(PermissionRequest)
...
public final class PermissionRequest {
    ...
    public static final class Builder {
         ...
         * <p>
         * The default rationale text is {@link R.string#permission_need_apply}.
         *
        ...
        public PermissionRequest build() {
            if (mRationale == null) {
                mRationale = mHelper.getContext().getString(R.string.permission_need_apply);
            }

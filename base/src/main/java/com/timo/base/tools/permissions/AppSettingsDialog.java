...
public class AppSettingsDialog implements Parcelable {
    ...
    public static class Builder {
         ...
         * PermissionUtils#hasPermissions(Context, String...)} in {@link
        ...
        public AppSettingsDialog build() {
            mRationale = TextUtils.isEmpty(mRationale) ?
                    mContext.getString(R.string.permission_to_setting) : mRationale;
            mTitle = TextUtils.isEmpty(mTitle) ?
                    mContext.getString(R.string.permission_need) : mTitle;

...
public class ToastUtils {
    ...
    public Toast warning(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = XOutdatedUtils.getInstance().getDrawable(R.mipmap.toast_warning);
        }
    ...
    public Toast info(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = XOutdatedUtils.getInstance().getDrawable(R.mipmap.toast_info);
        }
    ...
    public Toast success(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = XOutdatedUtils.getInstance().getDrawable(R.mipmap.toast_success);
        }
    ...
    public Toast error(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = XOutdatedUtils.getInstance().getDrawable(R.mipmap.toast_error);
        }
    ...
    public Toast custom(@NonNull String message, Drawable icon, @ColorInt int textColor, @ColorInt int tintColor, int duration) {
        ...
        Drawable drawableFrame = XOutdatedUtils.getInstance().getDrawable(R.mipmap.toast_frame);
